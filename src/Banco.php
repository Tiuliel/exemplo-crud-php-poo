...
abstract class Banco{
    ...
    /* Propriedades/atributos estáticos para acesso ao Banco */
private static string $servidor = "localhost";
private static string $usuario = "root";
private static string $senha = "";
private static string $banco = "vendas";
/* Classes internas do próprio PHP (como é o caso da PDO)
precisam do use NomeDaClasse ou uma barra invertida no momento da criação (como abaixo) 
private static \PDO $conexao
*/
private static PDO $conexao; // Se for desta forma, é usado "use PDO"

// Métado de conexão ao banco(será usado pelas outras Classes)
